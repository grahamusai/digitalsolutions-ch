...
export const metadata: Metadata = {
  title: "Digital Solutions | Swiss Digital Agency - Web, Mobile & Cloud Solutions",
  description:
    "Swiss-based digital agency specializing in web development, mobile applications, cloud architecture, cybersecurity, and custom business software. Transform your digital presence with innovation.",
  generator: "v0.app",
}
